...
'examples-automorphic' : 'Examples of Stacks,',\
'automorphic-sheaves' : 'Sheaves on Stacks,',\
'criteria' : 'Criteria for Representability,',\
'artin' : 'Artin\'s Axioms,',\
'quot' : 'Quot,',\
'automorphic-properties' : 'Properties of Stacks,',\
'automorphic-morphisms' : 'Morphisms of Stacks,',\
'automorphic-cohomology' : 'Cohomology of Stacks,',\
'automorphic-limits' : 'Limits of Stacks,',\
'automorphic-perfect' : 'Derived Categories of Stacks,',\
'automorphic-introduction' : 'Introducing Algebraic Stacks,',\
'automorphic-more-morphisms' : 'More on Morphisms of Stacks,',\
'examples' : 'Examples,',\
'exercises' : 'Exercises,',\
