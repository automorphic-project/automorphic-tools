...
def split_label(label):
	...
	if name == "formal" and type == "defos":
		...
		type = pieces[2]
		n = 3
	if name == "examples" and type == "automorphic":
		name = "examples-automorphic"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "sheaves":
		name = "automorphic-sheaves"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "properties":
		name = "automorphic-properties"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "morphisms":
		name = "automorphic-morphisms"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "limits":
		name = "automorphic-limits"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "cohomology":
		name = "automorphic-cohomology"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "perfect":
		name = "automorphic-perfect"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "introduction":
		name = "automorphic-introduction"
		type = pieces[2]
		n = 3
	if name == "automorphic" and type == "more" and pieces[2] == "morphisms":
		name = "automorphic-more-morphisms"
		type = pieces[3]
		n = 4
	while n < len(pieces):
		rest = rest + "-" + pieces[n]
